...
namespace ContosoU2016.Data
{
    ...
    public class SchoolContext: DbContext  //Derives from the System.Data.Entity.DBContext class
    {
         ...
         * property names. Property names for collections are typically plural (Students Rather than Student).
         * Developers disagree about wether table names should be pluralized or not. 
