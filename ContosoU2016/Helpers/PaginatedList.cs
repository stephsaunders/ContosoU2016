...
namespace ContosoU2016.Helpers
{
    public class PaginatedList<T> : List<T>
    {
        ...
        public static async Task<PaginatedList<T>> CreateAsync(IQueryable<T> source, int pageIndex, int pageSize)
        {
            ...
            /*
             * This method takes the page size and page number and applies the appropriate Skip and take 
             ...
             * and Next paging Buttons in UI
             * 
             * The CreateAsync method is used instead of a constructor to create the Pagined List
